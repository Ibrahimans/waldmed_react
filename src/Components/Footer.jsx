                        ...
                        <Col lg='4'>
                            <Container>
                                <Row>
                                    ...
                                    <Col lg='12' xs='12' style={{ margin: '5px' }}><a style={{ textDecoration: 'none' }} href='/'>Home</a></Col>
                        ...
                        <Col lg='4'>
                            <Container>
                                <Row>
                                    ...
                                    <Col lg='12' style={{ fontSize: '1.5vh', marginTop: '7.5vh' }}><a style={{ textDecoration: 'none' }} href='/about_us/'>The Waldorf Medical Clinic </a>is a family-run doctors office that focuses on you, the patient.
